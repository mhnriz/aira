...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.aira/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.aira/skills/inspect/SKILL.md">\nReferences are relative to /project/.aira/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
