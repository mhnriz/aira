 ...
 * - ~/.aira/agent/extensions/sandbox.json (global)
 * - <cwd>/.aira/sandbox.json (project-local)
 *
 * Example .aira/sandbox.json:
 * ```json
 * {
 *   "enabled": true,
 *   "network": {
 ...
 *
 * Setup:
 * 1. Copy sandbox/ directory to ~/.aira/agent/extensions/
 * 2. Run `npm install` in ~/.aira/agent/extensions/sandbox/
 *
