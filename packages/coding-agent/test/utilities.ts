...
// ============================================================================
// OAuth API key resolution from ~/.aira/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".aira", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.aira/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.aira/agent/auth.json
 */
...
/** Path to the real aira agent config directory */
export const AIRA_AGENT_DIR = join(homedir(), ".aira", "agent");

/**
 * Get an AuthStorage instance backed by ~/.aira/agent/auth.json
