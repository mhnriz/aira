...
describe("Aira /doctor command (Phase 3 scope)", () => {
	it("passes all checks with a live canonical state and default keybindings", () => {
	...
	it("formats a human-readable report with a summary", () => {
		...
		expect(text).toContain("summary: 5/5 checks passed");
