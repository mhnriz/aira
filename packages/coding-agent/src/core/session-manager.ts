 ...
 * Encodes cwd into a safe directory name under ~/.aira/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.aira/agent/sessions/<encoded-cwd>/).
	 */
