...
export function toAiraChildSnapshot(run: AiraChildRun): AiraChildSnapshot {
	return {
		...
		...(run.toolBudgetUsed !== undefined ? { toolBudgetUsed: run.toolBudgetUsed } : {}),
		...(run.toolBudgetLimit !== undefined ? { toolBudgetLimit: run.toolBudgetLimit } : {}),
		...(run.toolBudgetExtensions !== undefined ? { toolBudgetExtensions: run.toolBudgetExtensions } : {}),
